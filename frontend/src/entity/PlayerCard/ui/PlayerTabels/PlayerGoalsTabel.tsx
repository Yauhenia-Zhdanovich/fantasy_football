...
export const PlayerGoalsTabel: FC = () => {
  return (
      ...
      <Table aria-label="simple table">
        ...
        >
          ...
          >
            ...
            <CustomTabelCell align="left">Conceded</CustomTabelCell>
            <CustomTabelCell align="left">Assists</CustomTabelCell>
            <CustomTabelCell align="left">Saves</CustomTabelCell>
          </TableRow>
        </TableHead>
        <TableBody>
          <TableRow
